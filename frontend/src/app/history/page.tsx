...
function History() {
  return (
    <main className="min-h-screen py-5">
      ...
      <Contact contactName={"Sujata"} btnIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-green-600">
