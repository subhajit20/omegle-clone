  ...
  return (
        <div className='w-full relative'>
            ...
            <div className='flex justify-center gap-3 w-full mb-3 fixed bottom-0'>
                ...
                {/* Send Message button */}
                <Button btnStyle={'btn outline success'} btnHandler={props.sendMsg} btnText={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
